...
public class MainActivity extends AppCompatActivity {
  ...
  public void btnSignUpFunc(View view) {
    ...
    if (currUserName.isEmpty() || currUserName.length() < 3) {
      ...
      Cursor c =
          gameDB.rawQuery("SELECT * FROM users WHERE username = '" + currUserName + "'", null);
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // IF YOU GET AN ERROR UNCOMMENT THESE 2 LINES AND RUN ONCE, THEN comment Out these 2 lines
    // again
    ...
    gameDB.execSQL(
        "CREATE TABLE IF NOT EXISTS users (username VARCHAR, password VARCHAR, currLevel INT(2), "

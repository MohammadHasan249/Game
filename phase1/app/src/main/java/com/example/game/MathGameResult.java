...
public class MathGameResult extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    // Math.round will round to nearest decimal, so if get a value of something like 0.131123 but if
    // round this
    // to nearest decimal will be 0, so need to multiple by 100 --> 13.1123 then round to remove
    // excess digits --> 13 divide by 100 --> 0.13

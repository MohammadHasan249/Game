...
public class EndGameResultPage extends AppCompatActivity {
    ...
    private void setScore(
            CurrUser user,
            TextView diffcultyTextView,
            TextView l1TextView,
            TextView l2TextView,
            TextView l3TextView) {
        diffcultyTextView.setText(user.getDifficultySelected());
        String l1score = user.getL1RecentScore() + " number of clicks";
        String l2score = user.getL2RecentScore() + " number correct";
        String l3score = user.getL3RecentScore() + " seconds";
